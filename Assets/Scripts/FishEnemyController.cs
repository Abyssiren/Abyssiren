                ...
                default:
                    ...
                    else
                    {
                        ...
                        if(!attackSounding)
                        {
                            ...
                            attackSounding = true;
                            DrawLine(transform.position, playerObject.transform.position - playerObject.transform.up/2 + (playerObject.transform.position - transform.position).normalized * 4, 0.4f);
                        }
                        if(countdown > 0)
                        {
